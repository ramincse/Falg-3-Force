                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data -> title }}</td>
                                            <td>
                                                <img style="width: 260px; height: 60px; border-radius: 4px;" src="{{ URL::to('/') }}/media/slider/{{ $data -> photo }}" alt="">
                                            </td>
                                            <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input name="btn_text" class="form-control" type="text" placeholder="Button Text">
